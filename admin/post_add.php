...
if(isset($_POST['submit'])) {
    ...
    if($extension == 'jpg'||$extension == 'png'||$extension == 'gif') {        
        if ($fsize>=1000000) {
            ...
            $sql = "INSERT INTO products(shortname, description, price, gender, img) VALUE('".$_POST['shortname']."','".$_POST['description']."','".$_POST['price']."','".$_POST['gender']."','".$fnew."')";
...
<head>
    ...
    <title>Добавить афишу | Администратор ГПКиО</title>
</head>
<body>
    <header class="header">
        ...
        <div class="wrapper">
            <form class="form" action='' method='post' enctype="multipart/form-data">
                <div class="form__item short-form">
                    ...
                    <input type="text" name="shortname" id="title">
                </div>
                <div class="form__item short-form">
                    <label for="start">Цена</label>
                    <input type="text" name="price" id="start">
                </div>
